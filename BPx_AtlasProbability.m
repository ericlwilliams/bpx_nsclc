...
load(strcat(fp,fn),'CGobj_current');
    ...
    CGobj_current = CGobj_current.fCrudeAtlas_DVH(-1);
  ...
  CGobj_current.fProbabilityFig_DVH('');
  hold on;
...
%   title('Probability of true Esophageal Toxicity $\geq$ 20\%','interpreter','latex');
  ...
  % 5 fraction
    CGobj_current = CGobj_current.fCrudeAtlas_DVH(5);
    CGobj_current = CGobj_current.fBetaCumulativeProbability_DVH();
...
%   title('Probability of true Esophageal Toxicity $\geq$ 20\%','interpreter','latex')
  ...
  % 4 fraction
    CGobj_current = CGobj_current.fCrudeAtlas_DVH(4);
    CGobj_current = CGobj_current.fBetaCumulativeProbability_DVH();
...
%  ylim([0.1,15]);
  ...
  if do_print,
   ...
   disp(['Saving ',fig_basename,'_4fx_prob.pdf...']);
    ...
    % 3 fraction
    CGobj_current = CGobj_current.fCrudeAtlas_DVH(3);
    CGobj_current = CGobj_current.fBetaCumulativeProbability_DVH();
